...
\begin{grammar}
  ...
  <C> ::= \ttt{head} | \ttt{tail} | \ttt{cons} | \ttt{nil} | \ttt{foldr} | \ttt{scanr} | \ttt{pair} | \ttt{fst} | \ttt{snd} | \ttt{ifThenElse} | \lesseq\; | \eq
...
\[
  \begin{array}{cc}
    ...
    \\\\
    \labinfer[App-$\lambda$]{e_1\; e_2 \reduces e[x\mapsto e_2]}{e_1 \reduces \lambda x \ra e & e_2 \val}
    \\\\
    ...
    \\\\
    \labinfer[Head]{\head\; (\cons\; e_1\; e_2) \reduces e_1}{\cons\; e_1\; e_2 \val}
    ~~~
    \labinfer[Tail]{\tail\; (\cons\; e_1\; e_2) \reduces e_2}{\cons\; e_1\; e_2 \val}
    \\\\
    ...
    \\\\
    \labinfer[Foldr-3]{\foldr\; f\; z\; (\cons\; x\; xs) \reduces f\; x\; (\foldr\; f\; z\; xs)}{f \val & z \val & \cons\; x\; xs \val}
    % \\\\
    % % \infer{\ttt{scanr f z $e$} \reduces \ttt{cons e$'$ (f x
    \\\\
    \labinfer[Fst]{\fst\; (\pair\; e_1\; e_2) \reduces e_1}{\pair\; e_1\; e_2 \val}
    ~~~
    \labinfer[Snd]{\snd\; (\pair\; e_1\; e_2) \reduces e_2}{\pair\; e_1\; e_2 \val}
    \\\\
    ...
    \\\\
    \labinfer[Eq-True]{\eq\; e\; e}{e \val}
    ~~~
    \labinfer[Eq-False]{\eq\; e_1\; e_2}{e_1 \val & e_2 \val & e_1 \neq e_2}
