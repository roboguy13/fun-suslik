...
\begin{grammar}
  ...
  <C> ::= "convert"$_{"L","L"}$ | "fold"$_{"L"}$ | \ite\; | \lesseq\; | \eq\; | \add\; | \sub\; | \ttt{and}\; | \ttt{or}\; | \ttt{not}
...
singlyLinkedExample = SinglyLinked listExample

doublyLinkedExample : DoublyLinked
doublyLinkedExample = DoublyLinked listExample

sumSinglyLinkedExample : Int
sumSinglyLinkedExample = lift sumList singlyLinkedExample

sumDoublyLinkedExample : Int
sumDoublyLinkedExample = lift sumList doublyLinkedExample
\end{lstlisting}
