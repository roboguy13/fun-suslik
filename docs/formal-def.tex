...
\[
  \begin{array}{c}
    \infer{e \Hbigs r \pointsto i}{e \bigs\; i & i \in \mathbb{Z}}
    ~~~
    \infer{e \Hbigs r \pointsto b}{e \bigs\; b & b \in \mathbb{B}}
    \\\\
    \infer{e \Hbigs r \pointsto i \sep \overline{(r+j) \pointsto v_j}}{e \bigs\; C_i\; \overline{v_j}}
  \end{array}
\]
