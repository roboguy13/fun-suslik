...
\begin{lemma}
  ...
  $\cdot \genStep{A}{B} \cdot$ is a function from fun-SuSLik function branches to SuSLik inductive predicate branches.
\end{lemma}
...
\noindent
By doing this to every branch of a layout, we get a full translation from layouts to SuSLik inductive predicates.
