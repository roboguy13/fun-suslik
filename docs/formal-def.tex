...
\begin{itemize}
  ...
  \item No nested structures, since we only have \verb|intset| ghost variables,
    ...
    if we can find a way to extend SuSLik's capabilities or a way to mitigate this limitation. One way could be to provide SuSLik with a program
    sketch which directly implements the passing of results from one procedure to another (in order for this to work, a SuSLik bug regarding
