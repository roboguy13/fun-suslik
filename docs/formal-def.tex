...
\noindent
When a recursive constructor is lowered to a layout $L$, it requires all of its recursive subterms to also be lowered to the layout $L$ and not some other layout.
