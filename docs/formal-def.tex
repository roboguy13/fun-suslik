...
\begin{itemize}
  ...
  \item No nested structures (this requirement might be either lifted or relaxed later), since we only have \verb|intset| ghost variables,
    and no ghost variables which can reflect these more complicated structures.
\end{itemize}
