...
\begin{enumerate}
  ...
  \item Compositionality: Given two fun-SuSLik functions $f : A \ra B$ and $g : B \ra C$, we have
  ...
  \item For any other translation $t : FsExpr \ra SuSLik$ that also satisfies the above properties, we have
