...
\[
  \begin{array}{c}
    ...
    \\\\
    \infer{\Sigma ; \Gamma \vdash \lowerS{L} a : L}{\Sigma ; \Gamma \vdash a : D & \Sigma ; \Gamma \vdash L : D \hra \ttt{layout}[\Delta]}
    ~~~
    \infer{\Sigma ; \Gamma \vdash \liftS{L} r : D}{\Sigma ; \Gamma \vdash r : L & \Sigma ; \Gamma \vdash L : D \hra \ttt{layout}[\Delta]}
    \\\\
...
define a semantic function $\Hsem{\cdot} : \FsExpr \ra \Heap$ using $\bigs$ as follows:

\[
  \begin{array}{c}
    \infer{\Hsem{e} = r \pointsto i}{e \bigs\; i & i \in \mathbb{Z}}
    ~~~
    \infer{\Hsem{e} = r \pointsto b}{e \bigs\; b & b \in \mathbb{B}}
    \\\\
    \infer{\Hsem{e} = r \pointsto i \sep \overline{(r+j) \pointsto v_j}}{e \bigs\; C_i\; \overline{v_j}}
  \end{array}
\]
