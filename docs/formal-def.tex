...
\[
  \Gsem{\cdot} : Expr \ra \mathcal{P}(\mathbb{Z})
\]

\noindent
The codomain of $\Gsem{\cdot}$ is the
set of all possible ghost values. For example, for a fun-SuSLik list \verb|cons 1 (cons 2 (cons 3 nil))|, the possible
