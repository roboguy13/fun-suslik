...
\newcommand{\bigs}{{\color{blue}{\Downarrow}}}
\newcommand{\Lbigs}{{\color{blue}\;\mathcal{L}\!\!\Downarrow}}
\newcommand{\Abigs}{{\color{blue}\;\mathcal{A}\!\!\Downarrow}}
...
\newcommand{\toCtx}{{\color{blue}\vartriangleright}}

\newcommand{\seq}{{\color{blue}\vdash}}
