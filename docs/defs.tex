...
\newcommand{\concrete}{\textnormal{ concrete}}
...
\newcommand{\instantiate} [1] {\textnormal{\ttt{instantiate}}_{#1}}
...
\newcommand{\infers}{\;{\color{red}\Rightarrow}\;}
\newcommand{\checks}{\;{\color{blue}\Leftarrow}\;}

\newcommand{\layoutType} [1] {\mathcal{L}(#1)}

\newcommand{\wellformed} [1] {\;\textnormal{wellformed}_{#1}}

\newcommand{\step} [1] {\longrightarrow_{#1}}

\newcommand{\genStep} [2] {\step{\ttt{gen}(#1,#2)}}
\newcommand{\condStep} {\step{\ttt{cond}}}
\newcommand{\layoutStep} {\step{\ttt{layout}}}
\newcommand{\heapletStep} {\step{\ttt{heaplet}}}
